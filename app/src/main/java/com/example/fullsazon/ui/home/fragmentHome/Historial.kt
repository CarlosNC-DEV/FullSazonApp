...
import com.example.fullsazon.databinding.FragmentHistorialBinding
import com.example.fullsazon.model.local.db.ManagerhelperDb
import com.example.fullsazon.ui.dapter.historial.HistorialAdapter
...
class Historial : Fragment() {
    ...
    override fun onCreateView(
        ...
        val ovHistorial = inflater.inflate(R.layout.fragment_historial, container, false)
        binding = FragmentHistorialBinding.bind(ovHistorial)
        managerhelperDb = ManagerhelperDb(requireContext())

        val resul = managerhelperDb.historialFund()
        val rcvHistorial = binding.rcvHistorial
        rcvHistorial.layoutManager = LinearLayoutManager(requireContext())
